...
const products = [
 ...
 base: 'sky',
  ...
  bg: 'bg-[#e6f4ea]',         // Light background
  badgeBg: 'bg-[#4ba25c]',    // Solid badge color
  from: 'from-[#e6f4ea]',
  to: 'to-[#4ba25c]',
    }
  }, {
  ...
  bg: 'bg-[#f0eef9]',         // Light pastel background
  badgeBg: 'bg-[#7266a1]',    // Badge or highlight color
  from: 'from-[#f0eef9]',     // Gradient start
  to: 'to-[#7266a1]', 
    }
  }, {
    title: 'ET2 - Medium Tile Adhesive',
  ...
  bg: 'bg-[#f5f5f5]',         // Soft background
  badgeBg: 'bg-[#a0a0a0]',    // Badge color
  from: 'from-[#f5f5f5]',     // Gradient start
  to: 'to-[#a0a0a0]', 
    }
  }, {
    title: 'ET2 - Medium Tile Adhesive',
  ...
  {products.map((product, idx) => (
    ...
    >
      <MorphingDialogTrigger
        ...
        className="flex w-full max-w-[420px] h-[450px] flex-col overflow-hidden border border-zinc-200 bg-white shadow-sm hover:shadow-md transition-shadow duration-300 mx-auto p-4"
      >
        <MorphingDialogImage
          src={product.image}
          alt={product.title}
        ...
        <div className="p-4 flex justify-center">
          <MorphingDialogTitle className="text-center text-black text-lg font-bold px-4 py-2 border border-zinc-300 rounded-lg shadow-sm bg-gray-50-100 w-fit">
            {product.title}
          </MorphingDialogTitle>
        </div>
      </MorphingDialogTrigger>
