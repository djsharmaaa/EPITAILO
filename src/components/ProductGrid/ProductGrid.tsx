...
//         <div className="grid grid-cols-1 md:grid-cols-2 gap-8 m-4 md:ml-45 p-4 md:p-6 max-w-6xl mx-auto">
//           {products.map((product, i) => (
//             <div
//               key={i}
//               onClick={() => setSelectedProduct(product)}
//               className="cursor-pointer bg-white transition p-4 hover:scale-105"
//             >
//               <Image
//                 src={product.image}
//                 alt={product.title}
